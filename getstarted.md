...
subtitle: Three steps, three styles, one publishing workflow.
permalink: /getstarted
---

This page reproduces the raw Markdown README from the [DS4PS archive of Beautiful Jekyll](https://github.com/DS4PS/beautiful-jekyll/blob/master/README.md), the version used for this lab. The original author's wording is retained below; the first three setup steps have individually scoped styles.

**For this project:** the repository is named `lab-05-site`, so it uses a project-site address rather than the personal-site address described in the archived guide. GitHub Pages publishes the selected branch from its root folder. The configured base URL keeps internal links working under the repository name.

[Jump to the three styled steps](#fork-this-project).

<div class="readme-body" markdown="1">
...
To see an example of a markdown file, click on any file that ends in `.md`, for example [`aboutme.md`](aboutme). On that page you can see some nicely formatted text (there's a word in bold, a link, a few bullet points), and if you click on the pencil icon to edit the file, you'll see the markdown code that generated the pretty text. Very easy!

In contrast, look at [`tags.html`](tags/). That's how your write HTML - not as pretty. So stick with markdown if you don't know HTML.
...
Files you create inside the [`_posts`](https://github.com/DS4PS/beautiful-jekyll/tree/master/_posts) directory will be treated as blog entries. You can look at the existing files there to get an idea of how to write blog posts. Note the format of the blog post files - they must follow the naming convention of `YEAR-MONTH-DAY-title.md`. After you successfully add your own post, you can delete the existing files inside [`_posts`](https://github.com/DS4PS/beautiful-jekyll/tree/master/_posts) to remove the sample posts, as those are just demo posts to help you learn.
...
<style>
/* These selectors affect only the matching section's headings and paragraphs. */
.gs-section-01, .gs-section-02, .gs-section-03 { padding: 1.5rem; margin: 2rem 0; border-left: 5px solid; border-radius: 0 8px 8px 0; }
.gs-section-01 { background: #EFF7F6; border-color: #006B70; }
.gs-section-01 h3 { color: #005B60; font-family: Georgia, serif; font-size: 1.8rem; }
.gs-section-01 p { color: #244C4E; font-family: Georgia, serif; font-size: 1.15rem; line-height: 1.8; }
.gs-section-02 { background: #F0F4FA; border-color: #294D82; }
.gs-section-02 h3 { color: #244678; font-family: Arial, sans-serif; font-size: 1.5rem; text-transform: uppercase; letter-spacing: .035em; }
.gs-section-02 p { color: #30425E; font-family: Arial, sans-serif; font-size: 1.05rem; line-height: 1.7; }
.gs-section-03 { background: #FCF3ED; border-color: #944522; }
.gs-section-03 h3 { color: #813B1D; font-family: Georgia, serif; font-size: 1.7rem; font-style: italic; }
.gs-section-03 p { color: #623D2D; font-family: Georgia, serif; font-size: 1.1rem; line-height: 1.9; }
</style>
